...
xdmf = io.XDMFFile(domain.comm, "slab.xdmf", "w")  # Create an XDMF file for output
...
for i in range(num_steps):
    ...
    solver.solve(b, uCurr.x.petsc_vec)
    uCurr.x.scatter_forward()
    
    # Update solution at previous time step (uPrev)
    uPrev.x.array[:] = uCurr.x.array
